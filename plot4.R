plot4 <- function() {
    ...
    with(Power2007, plot(DateTime, Global_active_power, type = "n", xlab = "", ylab = "Global Active Power"))
    lines(Power2007$DateTime,Power2007$Global_active_power)
    
    with(Power2007, plot(DateTime, Voltage, type = "n", xlab = "datetime", ylab = "Voltage"))
    lines(Power2007$DateTime,Power2007$Voltage)
    ...
    with(Power2007, plot(DateTime, Global_reactive_power, type = "n", xlab = "datetime", ylab = "Global_reactive_power"))
